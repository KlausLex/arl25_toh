...
def execute_motion(dmp_gen, bag_path, dmp_save_path, cube_name, position_offset, publisher, 
    ...
    if motion_name == "pick":
        ...
        delay = 0.6* trajectory_execution_time
        print(f"Waiting for trajectory execution to complete ({delay:.2f} seconds)...")
        rospy.sleep(delay)
        detach_cube_from_gripper(cube_name)
        print(f"[{motion_name}] Detached {cube_name} from gripper.")
        print(f"Waiting for additional {0.4 * trajectory_execution_time + 2.0:.2f} seconds for detach to complete...")
        rospy.sleep(0.4* trajectory_execution_time+2.0)  # Wait for the detach to complete
    else: 
        rospy.sleep(trajectory_execution_time + 2.0)
...
if __name__ == "__main__":
    ...
    pick_bag_left_path = '/root/catkin_ws/recordings/pick_left11.bag'
    pick_bag_front_path = '/root/catkin_ws/recordings/pick_front10.bag'
    pick_bag_right_path = '/root/catkin_ws/recordings/pick_right11.bag'

    place_bag_left_path = '/root/catkin_ws/recordings/place_left10.bag'
    place_bag_front_path = '/root/catkin_ws/recordings/place_front10.bag'
    place_bag_right_path = '/root/catkin_ws/recordings/place_right10.bag'
    ...
    pick_dmp_left_path = '/root/catkin_ws/recordings/pick_left_motion10.pkl'
    pick_dmp_front_path = '/root/catkin_ws/recordings/pick_front_motion10.pkl'
    pick_dmp_right_path = '/root/catkin_ws/recordings/pick_right_motion10.pkl'

    place_dmp_left_path = '/root/catkin_ws/recordings/place_left_motion10.pkl'
    place_dmp_front_path = '/root/catkin_ws/recordings/place_front_motion10.pkl'
    place_dmp_right_path = '/root/catkin_ws/recordings/place_right_motion10.pkl'

    # pick_dmp_path= '/root/catkin_ws/recordings/learned_pick_left.pkl'
    # place_dmp_path = '/root/catkin_ws/recordings/learned_place_right.pkl'
