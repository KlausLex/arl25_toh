...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='DMP Motion Generator')
    parser.add_argument('--bag', dest='bag_path', required=False,
                        default='/root/catkin_ws/recordings/pick_front2.bag',
                        help='Path to the ROS bag file containing demonstrations')
    parser.add_argument('--dmp', dest='dmp_path', required=False,
                        default='/root/catkin_ws/recordings/learned_pick_front.pkl',
                        help='Path to save/load the DMP model')
    ...
    # bag_path = '/root/catkin_ws/recordings/pick_front2.bag'
    ...
    dmp_path = args.dmp_path #'/root/catkin_ws/recordings/learned_pick_front.pkl'
